...
from wtforms import StringField, PasswordField, FloatField, TextAreaField, SelectField, DateField, IntegerField, BooleanField
...
class RotturaForm(FlaskForm):
    ...
    data_acquisizione = DateField('Data Acquisizione', format='%d/%m/%Y', validators=[DataRequired()])
...
class RotturaEditForm(FlaskForm):
    ...
    data_acquisizione = DateField('Data Acquisizione', format='%d/%m/%Y', validators=[DataRequired()])
    data_elaborazione = DateField('Data Elaborazione', format='%d/%m/%Y', validators=[Optional()])
