...
# ============================================================================
# VECCHIO SISTEMA TRACCIAMENTO (MANTENUTO PER RETROCOMPATIBILITÀ)
# ============================================================================

class TraceElaborazione(db.Model):
    """Modello Tracciamento Elaborazioni - un file può avere più elaborazioni (VECCHIO SISTEMA)"""
    ...
    def get_file_object(self):
        """Restituisce l'oggetto file associato (FileOrdine, FileAnagrafica o FileRottura)"""
...
class TraceElaborazioneDettaglio(db.Model):
    """Modello Dettaglio Righe Elaborazione - anomalie/errori/warning per singola riga (VECCHIO SISTEMA)"""
